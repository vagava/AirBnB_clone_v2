...
def do_deploy(archive_path):
    ...
    try:
        ...
        run('mv /data/web_static/releases/{}/web_static/* /data/web_static/releases/{}/'.format(name_file, name_file))
        ...
        run('ln -s /data/web_static/releases/{}/ /data/web_static/current'.format(name_file))
    except Exception as e:
        return(False)
